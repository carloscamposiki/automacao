...
<html lang="en">
<head>
    <title>Code coverage report for transformElementCondition.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> transformElementCondition.js
    </h1>
    <div class='clearfix'>
...
<span class="fstat-no" title="function not covered" >        (e</span>lementOrLocator, ...args) =&gt;
<span class="cstat-no" title="statement not covered" >            new Condition('', wrappedConditionFactory(getWebElementImpl)(conditionRequiringElement, elementOrLocator, ...args));</span>
&nbsp;
